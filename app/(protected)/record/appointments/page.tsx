...
const Appointments = async (props: SearchParamsProps) => {
  ...
  return (
    <Card className="rounded-xl p-0 md:p-4 2xl:p-6 border-none md:border">
      <div className="flex items-center justify-between">
        ...
        <div className="w-full lg:w-fit flex flex-col md:flex-row items-center justify-between lg:justify-start gap-y-4 md:gap-2">
          <SearchInput />
